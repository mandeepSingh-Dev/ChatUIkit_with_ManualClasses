...
public class EaseImageGridFragment extends EaseBaseFragment implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        io.agora.chat.uikit.widget.video.EaseImageCache.ImageCacheParams cacheParams = new io.agora.chat.uikit.widget.video.EaseImageCache.ImageCacheParams();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        io.agora.chat.uikit.widget.video.EaseDividerGridItemDecoration itemDecoration = new io.agora.chat.uikit.widget.video.EaseDividerGridItemDecoration(mContext, R.drawable.ease_divider_video_list, false);
