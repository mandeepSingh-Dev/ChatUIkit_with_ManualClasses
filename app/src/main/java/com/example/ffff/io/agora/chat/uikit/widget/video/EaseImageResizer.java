...
public class EaseImageResizer extends EaseImageWorker {
     ...
     * @param imageHeight
     */
    public EaseImageResizer(Context context, int imageWidth, int imageHeight) {
        super(context);
     ...
     * @param imageSize
     */
    public EaseImageResizer(Context context, int imageSize) {
        super(context);
    ...
    public static Bitmap decodeSampledBitmapFromResource(Resources res,
                                                         int resId, int reqWidth, int reqHeight, io.agora.chat.uikit.widget.video.EaseImageCache cache) {
    ...
    public static Bitmap decodeSampledBitmapFromFile(String filename,
                                                     int reqWidth, int reqHeight, io.agora.chat.uikit.widget.video.EaseImageCache cache) {
    ...
    public static Bitmap decodeSampledBitmapFromDescriptor(
            ...
            io.agora.chat.uikit.widget.video.EaseImageCache cache) {
