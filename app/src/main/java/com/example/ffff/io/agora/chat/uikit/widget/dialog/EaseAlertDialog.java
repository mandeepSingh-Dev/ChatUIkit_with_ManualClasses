...
public class EaseAlertDialog extends Dialog {
    //Controller
    final io.agora.chat.uikit.widget.dialog.AlertController mAlert;
    ...
    public EaseAlertDialog(@NonNull Context context, int themeResId) {
        ...
        mAlert = new io.agora.chat.uikit.widget.dialog.AlertController(getContext(), this, getWindow());
    }
    ...
    public static class Builder<T extends EaseAlertDialog> {
        private final io.agora.chat.uikit.widget.dialog.AlertController.AlertParams P;
        private T dialog;
        ...
        public Builder(Context context, int themeResId) {
            P = new io.agora.chat.uikit.widget.dialog.AlertController.AlertParams(
                    context, themeResId);
        }
