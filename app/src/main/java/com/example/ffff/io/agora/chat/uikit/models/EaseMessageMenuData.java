package com.example.ffff.io.agora.chat.uikit.models;
...
public class EaseMessageMenuData {
    ...
    public static final int[] MENU_ITEM_IDS = {R.id.action_chat_thread
