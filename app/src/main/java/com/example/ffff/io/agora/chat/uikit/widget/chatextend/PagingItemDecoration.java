...
public class PagingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    io.agora.chat.uikit.widget.chatextend.PageDecorationLastJudge mPageDecorationLastJudge;

    public PagingItemDecoration(Context context, io.agora.chat.uikit.widget.chatextend.PageDecorationLastJudge pageDecorationLastJudge) {
