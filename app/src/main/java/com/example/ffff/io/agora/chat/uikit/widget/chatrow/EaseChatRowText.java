...
public class EaseChatRowText extends io.agora.chat.uikit.widget.chatrow.EaseChatRow {
    ...
    private void replaceSpan() {
        ...
        for (int i = 0; i < spans.length; i++) {
            ...
            if (index != -1) {
                ...
                spannable.setSpan(new io.agora.chat.uikit.widget.chatrow.AutolinkSpan(spans[i].getURL()), index
