...
public class StatusBarCompat {
    ...
    public static void setLightStatusBar(Activity activity, boolean dark) {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            switch (io.agora.chat.uikit.utils.RomUtils.getLightStatusBarAvailableRomType()) {
                case io.agora.chat.uikit.utils.RomUtils.AvailableRomType.MIUI :
                    setMIUISetStatusBarLightMode(activity, dark);
                    break;
                case io.agora.chat.uikit.utils.RomUtils.AvailableRomType.FLYME :
                    setFlymeLightStatusBar(activity, dark);
                    break;
                case io.agora.chat.uikit.utils.RomUtils.AvailableRomType.ANDROID_NATIVE :
    ...
    public static boolean setMIUISetStatusBarLightMode(Activity activity, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && io.agora.chat.uikit.utils.RomUtils.isMiUIV7OrAbove()) {
                    if (dark) {
